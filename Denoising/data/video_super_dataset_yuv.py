...
class VideoSuperDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        B_img = Image.open(os.path.join(B_paths, "image_%05d.png"%(start_idx))).convert('YCbCr') 
