...
class vid_inter_D(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if opt.no_3D == False:
            self.netD = networks.define_D(opt.loadSize, netD_input_nc, opt.ndf, opt.n_layers_D, opt.norm, use_sigmoid, opt.num_D, ganFeat_loss_3d, if_sn, opt.padding_mode, opt.gpu_ids)
