...
class vid_inter_G(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG = networks.define_G(conv_type=opt.G_conv_type, image_size=opt.loadSize, layer_num=layer_num, model_type=opt.model, input_channel=3, if_sn=if_sn, padding_mode=opt.padding_mode, gpu_ids=opt.gpu_ids)
