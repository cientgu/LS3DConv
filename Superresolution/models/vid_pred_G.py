...
class vid_pred_G(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # if opt.img2img == True:
        #     this_model_type = "mask2vid"
        #     layer_num = 9
        # else:
        #     this_model_type = opt.model

        self.netG = networks.define_G(conv_type=opt.G_conv_type, image_size=opt.loadSize, layer_num=opt.output_frames, model_type=opt.model, input_channel=3, if_sn=if_sn, padding_mode=opt.padding_mode, gpu_ids=opt.gpu_ids)
