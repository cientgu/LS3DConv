...
class VideoSuperDataset(BaseDataset):
    ...
    def get_image(self, A_path, transform_scaleA, is_label=False):
        ...
        # A_img = transforms.functional.adjust_hue(A_img, 0.02*(random.random()-0.5))
        # A_img = transforms.functional.affine(A_img, 5*rotate,[0,0],1+0.1*scale,3*shear,resample=Image.BICUBIC)
