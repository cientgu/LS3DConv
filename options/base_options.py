...
class BaseOptions():
    ...
    def initialize(self):               
        ...
        self.parser.add_argument('--no_D', action='store_true', help='if specified we do not use D')
        self.parser.add_argument('--use_yuv', action='store_true', help='we use yuv instead of rgb')
