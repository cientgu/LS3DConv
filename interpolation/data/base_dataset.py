...
def get_img_params(opt, size):
    ...
    if 'crop' in opt.resize_or_crop or 'scaledCrop' in opt.resize_or_crop:
        ...
        # crop_x = random.randint(14, np.maximum(0, 14+(new_w - crop_w)//2))  # this line and next line is for baseball only
        # crop_y = random.randint(42, np.maximum(0, new_h - crop_h))        # 
    else:
